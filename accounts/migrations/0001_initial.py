"""
Initial migration for accounts app - CustomUser model.
"""
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('age', models.IntegerField(help_text="User's age. Must be >= 15 to register.")),
                ('can_be_contacted', models.BooleanField(default=False, help_text='RGPD: User consent to be contacted')),
                ('can_data_be_shared', models.BooleanField(default=False, help_text='RGPD: User consent to share data')),
