"""
Configuration Django pour le projet softdesk.

Configuration clé :
- CustomUser comme modèle utilisateur
- JWT pour l'authentification (simplejwt)
- Pagination globale (10 items/page)
- Apps : accounts (utilisateurs) + tracker (projets/issues/comments)
"""
...
# - Pagination globale : 10 items par page (StandardPagination)
REST_FRAMEWORK = {
